servicos = {
         1:{'id': 1, 'categoria': 'FARMÁCIA', 'nome': 'ATENDIMENTO FARMACÊUTICO', 
            ...
            'documentos': ['Receita', 'Carteira de Identidade', 'Cartão do SUS', 'CPF'], 'tempo_atendimento': '00:20:00', 'upload': "True"},
         ...
         2:{'id': 2,'categoria': 'EXAMES', 'nome': 'MARCAÇÃO DE EXAMES', 
            ...
            'documentos': 'Documentos do serviço B', 'tempo_atendimento': '00:30:00', 'upload': "True"},
         ...
         3:{'id': 3,'categoria': 'AUTORIZAÇÕES', 'nome': 'AUTORIZAÇÃO DE PROCEDIMENTOS', 
            ...
            'documentos': 'Documentos do serviço C', 'tempo_atendimento': '00:10:00', 'upload': "True"},
         ...
         4:{'id': 4,'categoria': 'TRATAMENTOS', 'nome': 'TRATAMENTO FORA DO DOMICÍLIO - TFD', 
            ...
            'documentos': 'Documentos do serviço D', 'tempo_atendimento': '00:05:00', 'upload': "True"},

         5:{'id': 5,'categoria': 'SUS', 'nome': 'CARTÃO DO SUS', 
            'descricao': 'Emissão ou atualização do Cartão Nacional de Saúde - SUS.', 
            'documentos': 'Documentos do serviço E', 'tempo_atendimento': '00:40:00', 'upload': "False" }
      }
