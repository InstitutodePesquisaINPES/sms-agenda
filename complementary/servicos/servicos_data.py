servicos = {
         1:{'id': 1, 'categoria': 'FARMÁCIA', 'nome': 'ATENDIMENTO FARMACÊUTICO', 
            ...
            'documentos': ['Receita', 'RG', 'Cartão do SUS', 'CPF'], 'tempo_atendimento': '00:20:00', 'upload': "True"},
         ...
         2:{'id': 2,'categoria': 'EXAMES', 'nome': 'MARCAÇÃO DE EXAMES', 
            ...
            'documentos': ['Pedido Medico', 'Cartão SUS', 'RG', 'CPF'],  'tempo_atendimento': '00:30:00', 'upload': "True"},
         ...
         3:{'id': 3,'categoria': 'AUTORIZAÇÕES', 'nome': 'AUTORIZAÇÃO DE PROCEDIMENTOS', 
            ...
            'documentos': ['Auditoria do pedido', 'Cartão SUS', 'RG'], 'tempo_atendimento': '00:10:00', 'upload': "True"},
         ...
         4:{'id': 4,'categoria': 'TRATAMENTOS', 'nome': 'TRATAMENTO FORA DO DOMICÍLIO - TFD', 
            ...
            'documentos_Paciente': [ 'Laudo médico padrão TFD','Exames', 'Relatorios Médicos', 'Cartão SUS', 'RG', 'CPF', 'Comprovante de Residencia'], 'tempo_atendimento': '00:05:00', 'upload': "True"
            'documentos_Acompanhante' [ 'RG', 'CPF', 'Comprovante de Residencia',' Extrato Conta Bancária', 'Cartão SUS'], 'tempo_atendimento': '00:05:00', 'upload': "True" },


         5:{'id': 5,'categoria': 'SUS', 'nome': 'CARTÃO DO SUS', 
            'descricao': 'Emissão ou atualização do Cartão Nacional de Saúde - SUS.', 
            'documentos': ['RG', 'CPF', 'Comprovante de residencia com CEP'], 'tempo_atendimento': '00:40:00', 'upload': "False" }
      }
